...
outcome1s = {
    0: ("\n\n1. Spend money to send firefighters to reduce the blaze", -10, 5, .05),
    1: ("\n\n1. Spend money to evacuate the area", -15, 10, .05),
    2: ("\n\n1. Fund aid for those who were affected", -8, 5, .05),
    3: ("\n\n1. Spend money to evacuate the area near the volcano", -15, 5, .05),
    4: ("\n\n1. Publicly condemn mass use of factories", 0, 0, .02),
    5: ("\n\n1. Promise to decrease carbon emissions by even more", -5, 0, .03),
    6: ("\n\n1. Fund incentives to encourage companies to stop using mines", -8, -3, .01),
    7: ("\n\n1. Fund incentives to decrease oil in the water source", -15, -3, .08),
    8: ("\n\n1. Reprimand Mr. Musk and spend money to shut down the chemical plant immediately", -7, -.08, .05),
    9: ("\n\n1. Spend money on lobbying to reject new energy source and push for renewable energy", -8, -9, .07),
...
outcome2s = {
    ...
    3: ("\n2. Let the eruption calm down by itself", 0, 10, -.09),
    4: ("\n2. Refuse to acknowledge the competition", 0, 0, -5),
    5: ("\n2. Refuse to acknowledge the campaign", 0, 0, -.03),
    6: ("\n2. Let the companies mine cobalt", 0, 8, -.03),
    7: ("\n2. Keep using the water source as a dump for oil", 20, -30, -.25),
    8: ("\n2. Loan money (with high interest) to Mr. Musk for exploitation program", 20, 30, -.25),
