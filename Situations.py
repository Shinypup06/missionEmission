...
outcome1s = {
    ...
    8: ("\n\n1. Reprimand Mr. Musk and spend money to shut down the chemical plant immediately", -14, -.16, .1),
    9: ("\n\n1. Spend money on lobbying to reject new energy source and push for renewable energy", -16, -18, .14),
