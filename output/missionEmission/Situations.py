descriptions = {
    ...
    2: "An earthquake caused carbon to release \nthrough faults below the ground.",
    3: "A volcanic eruption caused massive amounts of CO2 gas to \nbe released through magma, volcanic lakes, and hot springs.",
    ...
    7: "15 million barrels of oil has spilled \ninto a drinkable water source.",
    ...
    10: "A new cryptocurrency KESHcoin has sparked \nthousands of crypto mining farms.",
    ...
    20: "The president has passed a bill allowing \nthe use of mass fracking.",
    ...
    24: "Many citizens are getting sick because of factories \nreleasing toxic gasses into the air.",
...
outcome1s = {
    ...
    9: ("\n\n1. Spend money lobbying to reject the new \nenergy source and push for renewable energy", -16, -18, .14),
    ...
    15: ("\n\n1. Fund the passenger space vehicle program", -15, 30, .13),
    16: ("\n\n1. Cut ties with foreign nation", 0, 0, -.1),
    17: ("\n\n1. Put out statement condemning 'fast fashion'", -8, 8, -.06),
...
outcome2s = {
    ...
    7: ("\n2. Keep using the water source as a dump for oil", 40, -60, -.4),
    8: ("\n2. Loan money (with high interest) to Mr. Musk for exploitation program", 40, .06, -.4),
    ...
    20: ("\n2. Advocate for the bill, and receive \nmonetary incentives from the president.", 6, 3, -.1),
